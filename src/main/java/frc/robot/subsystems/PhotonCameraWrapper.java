    ...
    public PhotonCameraWrapper() {
        ...
        final AprilTag tag18 =
                new AprilTag(
                        ...
                        new Pose3d(
                                new Pose2d(
                                        FieldConstants.kLength,
                                        FieldConstants.kWidth / 2.0,
                                        Rotation2d.fromDegrees(180))));
        final AprilTag tag01 =
                new AprilTag(
                        01,
                        new Pose3d(new Pose2d(0.0, FieldConstants.kWidth / 2.0, Rotation2d.fromDegrees(0.0))));
        ...
        AprilTagFieldLayout atfl =
                new AprilTagFieldLayout(atList, FieldConstants.kLength, FieldConstants.kWidth);
