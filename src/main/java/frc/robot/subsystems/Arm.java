...
public class Arm extends SubsystemBase {
    ...
    private final MotorController m_tiltMotor = new CANSparkMax(ArmConstants.kTiltMotorPort, MotorType.kBrushed);
    ...
    public void armUp() {
        m_tiltMotor.set(ArmConstants.kTiltForwardSpeed);
    }

    public void armDown() {
        m_tiltMotor.set(ArmConstants.kTiltReverseSpeed);
    }
