...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kFrontLeftChassisAngularOffset = -0.88;
    public static final double kFrontRightChassisAngularOffset = 0.88;
    public static final double kBackLeftChassisAngularOffset = Math.PI + 0.88;
    public static final double kBackRightChassisAngularOffset = Math.PI - 0.88;
